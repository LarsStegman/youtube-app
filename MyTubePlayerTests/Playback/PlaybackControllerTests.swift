...
//        let playbackController = PlaybackQueueController()
//        XCTAssertNil(playbackController.currentItem)
//    }
//
//    func testNonEmptyInitNoCurrentItem() {
//        let playbackController = PlaybackQueueController(playerController: <#PlayerController#>, items: [TestPlayerItem()])
//        XCTAssertNil(playbackController.currentItem)
//    }
//
...
//        let playbackController = PlaybackQueueController(playerController: <#PlayerController#>, items: [])
//        XCTAssertNil(playbackController.currentItem)
//        playbackController.start()
//        XCTAssertNil(playbackController.currentItem)
//    }
...
//        let playbackController = PlaybackQueueController(items: [TestPlayerItem(), TestPlayerItem()])
